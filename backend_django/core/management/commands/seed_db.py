...
class Command(BaseCommand):
  ...
  def handle(self, *args, **kwargs):
    ...
    admin_email = 'admin@crimegpt.com'
    ...
    officers = []
    officer_data = [
      ('john@crimegpt.com', 'Officer John Smith', 'john@1234', 'BADGE-1001', db_locations[0], '9876543210'),
      ('sarah@crimegpt.com', 'Officer Sarah Connor', 'sarah@1234', 'BADGE-1002', db_locations[1], '9876543211'),
      ('david@crimegpt.com', 'Officer David Miller', 'david@1234', 'BADGE-1003', db_locations[3], '9876543212'),
      ('emily@crimegpt.com', 'Officer Emily Watson', 'emily@1234', 'BADGE-1004', db_locations[5], '9876543213'),
      ('james@crimegpt.com', 'Officer James Bond', 'james@1234', 'BADGE-0007', db_locations[6], '9870070070')
    ]
    ...
    # Seed 2 Analysts
    analyst_data = [
      ('carl@crimegpt.com', 'Analyst Carl Sagan', 'carl@1234', 'Cyber Intelligence Unit'),
      ('neha@crimegpt.com', 'Analyst Neha Verma', 'neha@1234', 'Forensic Data Division')
    ]
